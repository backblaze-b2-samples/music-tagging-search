...
from app.runtime import files, health, metrics, tracks, upload  # noqa: E402
...
app = FastAPI(
    title="Music Tagging & Search API",
    description="Music tagging + semantic audio search backed by Backblaze B2",
    version="0.1.0",
    lifespan=lifespan,
)
