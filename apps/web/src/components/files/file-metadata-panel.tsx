...
import type { FileMetadataDetail } from "@music-tagging-search/shared";
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3 px-5 pb-5">
        ...
        {/* Audio probe (cheap, at upload time). Full MIR features live on the
            Library page after analysis. */}
        {metadata.duration_seconds !== null && (
          <>
            ...
            {metadata.sample_rate && (
              <MetaRow label="Sample rate" value={`${metadata.sample_rate} Hz`} />
            )}
            {metadata.channels && (
