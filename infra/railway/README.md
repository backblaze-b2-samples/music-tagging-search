# Railway Deployment — music-tagging-search

Deploy both services (web + api) on Railway.

> The API service installs Essentia, laion-clap, and LanceDB — give the build a
> generous timeout, and the runtime container enough RAM (~4 GB) and disk for the
> one-time CLAP weight download.
